...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "You meant to forgive me right?🤨";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "Knew it love 🖤";
  yes.innerHTML = '<a href="https://www.instagram.com/deadlinesuri/">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
